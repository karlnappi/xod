...
describe('autoresolveTypes', () => {
  ...
  it('detects missing specializations', () => {
    Helper.expectEitherError(
      "Can't find specializations for abstrat patch @/pulse-on-change",
  ...
  it('detects conflicting specializations', () => {
    ...
    Helper.expectEitherError(
      'Conflicting specializations for abstrat patch @/pulse-on-change: @/pulse-on-change(number), some/other-library/pulse-on-change(number). Switch to one of them explicitly to continue.',
